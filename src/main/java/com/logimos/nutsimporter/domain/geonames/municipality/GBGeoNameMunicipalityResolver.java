...
public class GBGeoNameMunicipalityResolver implements GeoNameMunicipalityResolver {
    ...
    public Municipality resolveMunicipality(String countryCode, String placeName, Point point) {
        ...
        Municipality municipality = findMunicipality(countryCode, placeName, point);
        ...
        if (results.isEmpty()) {
            LOGGER.info("Place not found by name, searching closest... ({})", placeName);
        ...
        if (results.isEmpty()) {
            LOGGER.warn("Place not found for {}. Searching closest admin area...", placeName);
    ...
    private Municipality findMunicipality(String countryCode, String placeName, Point point) {
